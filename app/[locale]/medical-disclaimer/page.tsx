...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "PepVise publishes educational content about GLP-1 medications. This page explains what that does and doesn't mean.",
...
export default function MedicalDisclaimerPage() {
  return (
    <TrustPageTemplate title="Medical Disclaimer">
      <p>
        Information on PepVise is for <strong>educational purposes only</strong>.
        It is not medical advice, diagnosis, or treatment. PepVise is not a
      ...
      <p>
        GLP-1 research is moving quickly. PepVise updates posts as new trials
      ...
      <p>
        By using PepVise, you acknowledge that you will not use content on this
