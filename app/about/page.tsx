...
export default function AboutPage() {
  return (
    <TrustPageTemplate title="About PepVise">
      <p>PepVise is the friend who already went through it.</p>
      <p>
      ...
      <p>
        ...
        medical journals and Reddit threads. PepVise is the third option: warm,
        accurate, calm, cited.
      </p>
      ...
      <p>
        ...
        Tell us. Write to us at <Link href="/contact">hello@pepvise.com</Link>.
      </p>

      <p>The PepVise Editorial Team</p>
    </TrustPageTemplate>
  );
}
