...
export const metadata: Metadata = pageMetadata({
  ...
  description: "The terms that govern your use of PepVise.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <TrustPageTemplate title="Terms of Service">
      ...
      <p>
        By accessing pepvise.com (&ldquo;the Site&rdquo;), you agree to
        these Terms. If you don&apos;t agree, don&apos;t use the Site.
      </p>

      <h2>1. The Site is informational</h2>
      <p>
        PepVise publishes editorial content about non-toxic living,
      ...
      <p>
        ...
        PepVise or licensed to us. You may share excerpts with
      ...
      <p>
        To the maximum extent permitted by law, PepVise is not liable
      ...
      <h2>10. Contact</h2>
      <p>Questions about these Terms? Email hello@pepvise.com.</p>
    </TrustPageTemplate>
  );
}
