...
const ENTRIES: ReviewEntry[] = [
  ...
  },
  {
    ...
    references: [
      { label: "Jastreboff et al. 2023, retatrutide Phase 2 obesity, NEJM", url: "https://pubmed.ncbi.nlm.nih.gov/37356458/" },
      { label: "Rosenstock et al. 2023, retatrutide Phase 2 T2D, Lancet", url: "https://pubmed.ncbi.nlm.nih.gov/37356450/" },
      { label: "Sanyal et al. 2024, retatrutide for hepatic steatosis Phase 2, Lancet Gastroenterol Hepatol", url: "https://pubmed.ncbi.nlm.nih.gov/38458206/" },
      { label: "ClinicalTrials.gov, TRIUMPH-1 through TRIUMPH-4 (retatrutide Phase 3)", url: "https://clinicaltrials.gov/search?term=retatrutide+TRIUMPH" },
      { label: "Eli Lilly investor disclosures, retatrutide development pipeline", url: "https://investor.lilly.com/" },
    ],
  ...
  },
  {
    ...
    references: [
      { label: "Wilding et al. 2021, STEP-1 obesity trial, NEJM", url: "https://pubmed.ncbi.nlm.nih.gov/33567185/" },
      { label: "Marso et al. 2016, SUSTAIN-6 cardiovascular outcomes (T2D), NEJM", url: "https://pubmed.ncbi.nlm.nih.gov/27633186/" },
      { label: "Lincoff et al. 2023, SELECT cardiovascular outcomes (obesity), NEJM", url: "https://pubmed.ncbi.nlm.nih.gov/37952131/" },
      { label: "Davies et al. 2017, SUSTAIN-2, Lancet", url: "https://pubmed.ncbi.nlm.nih.gov/29032024/" },
      { label: "Husain et al. 2019, PIONEER 6 oral semaglutide CV safety, NEJM", url: "https://pubmed.ncbi.nlm.nih.gov/31185157/" },
      { label: "FDA Drugs@FDA, semaglutide labeling (Ozempic, Wegovy, Rybelsus)", url: "https://www.accessdata.fda.gov/scripts/cder/daf/" },
    ],
