...
export const posts: Post[] = [
    ...
    products: [
      {
        ...
        tier: "Textbook",
        summary:
          // audit-claims:allow — "treats X as Y" idiomatic usage, not a medical claim
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        // audit-claims:allow — "regulatory framework treats X seriously" idiomatic usage
  ...
  },
  {
    ...
    title: "Wegovy vs. Zepbound, the Pepvise Comparison",
    h1: "Wegovy vs. Zepbound: the head-to-head verdict",
    description:
      "Methodology v1.2 comparison of semaglutide 2.4 mg (Wegovy) and tirzepatide 15 mg (Zepbound) for chronic weight management. SURMOUNT-5 head-to-head, dose ladders, side-effect profile, cardiovascular evidence.",
    hub: "evidence-reviews",
    postType: "comparison",
    ...
    faq: [
      {
        q: "Which one produces more weight loss?",
        a: "On the published trial data, tirzepatide produces more. SURMOUNT-1 at the 15 mg arm reported approximately 22.5% mean weight loss at 72 weeks. STEP-1 at the 2.4 mg arm reported approximately 14.9% at 68 weeks. SURMOUNT-5 (2025) ran the head-to-head and confirmed the gap at the time-matched comparison. Real-world weight outcomes are smaller than trial means for both molecules and depend heavily on titration tolerance.",
      },
      {
        q: "Which one has cardiovascular outcomes evidence?",
        a: "Wegovy. The SELECT trial (Lincoff 2023) demonstrated MACE reduction in adults with established cardiovascular disease at the 2.4 mg/week dose. SURPASS-CVOT for tirzepatide does not read out until 2026 — until then, semaglutide is the molecule with the published cardiac benefit signal in the chronic-weight-management label population.",
      },
      {
        q: "Are the side-effect profiles different?",
        a: "Both molecules drive a similar pattern of titration-phase GI side effects: nausea, vomiting, diarrhea, constipation. Trial-reported discontinuation is around 6–7% for tirzepatide on SURMOUNT-1 and approximately 5–6% for semaglutide on STEP-1. Real-world discontinuation is meaningfully higher than trial cohorts for both. The GIP component of tirzepatide may modestly reduce some GI burden at matched titration in some patient subgroups, but the pattern is not consistent across published trial reports.",
      },
      {
        q: "What about cost and access?",
        a: "List prices in the US are comparable — approximately $1,000–1,350 per month before manufacturer savings programs and insurance coverage. The Eli Lilly direct-to-pharmacy supply pathway for Zepbound has been more reliable than the Wegovy supply chain through 2024–2025, where intermittent shortages drove substitution to compounded semaglutide. Insurance coverage for chronic weight management remains the dominant access barrier for both. We do not link to any pharmacy or telehealth vendor — affiliate boundaries documented in /affiliate-disclosure.",
      },
      {
        q: "Does the methodology penalise tirzepatide for the cardiovascular outcomes gap?",
        a: "Yes, indirectly. The methodology v1.2 'human evidence' dimension scores trial breadth and population coverage; SURPASS-CVOT not yet reading out is part of why tirzepatide does not earn the methodology ceiling of 9.5. Once SURPASS-CVOT reads out, the score will re-rate. Each review embeds the methodology version it was scored against — see /methodology/v1-2 for the dimension definitions.",
      },
      {
        q: "Are there drug-class side effects to watch for?",
        a: "The class boxed-warning pattern includes thyroid C-cell tumours observed in rodents (clinical relevance unestablished for both molecules), risk of pancreatitis, gallbladder events, acute kidney injury during severe GI dehydration episodes, and ileus. Both labels carry these warnings. Patients with personal or family history of medullary thyroid carcinoma or MEN-2 syndrome are contraindicated for both molecules.",
      },
    ],
    sources: [
      { label: "Wilding et al. 2021, STEP-1, New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/33567185/" },
      { label: "Jastreboff et al. 2022, SURMOUNT-1, New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/35658024/" },
      { label: "Lincoff et al. 2023, SELECT cardiovascular outcomes, New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/37952131/" },
      { label: "Garvey et al. 2023, SURMOUNT-2 (T2D), Lancet", url: "https://pubmed.ncbi.nlm.nih.gov/37364590/" },
      { label: "Rubino et al. 2021, STEP-4, JAMA", url: "https://pubmed.ncbi.nlm.nih.gov/33755728/" },
      ...
      { label: "EMA Wegovy EPAR", url: "https://www.ema.europa.eu/en/medicines/human/EPAR/wegovy" },
      { label: "Pepvise methodology v1.2", url: "/methodology/v1-2" },
    ],
  },
  {
    slug: "mounjaro-vs-ozempic",
    title: "Mounjaro vs. Ozempic, the Pepvise Comparison",
    h1: "Mounjaro vs. Ozempic: the head-to-head verdict",
    description:
      "Methodology v1.2 comparison of tirzepatide (Mounjaro) and semaglutide (Ozempic) for type-2 diabetes. SURPASS-2 head-to-head, dose ladders, weight effects, cardiovascular evidence, and the indication-driven prescribing context.",
    hub: "evidence-reviews",
    postType: "comparison",
    publishedAt: "2026-04-28",
    updatedAt: "2026-04-28",
    ...
    faq: [
      {
        q: "Which produces more weight loss in T2D patients?",
        a: "Tirzepatide. SURPASS-2 (40 weeks) reported mean weight reductions of approximately 7.6 to 11.2 kg across the 5/10/15 mg dose levels versus 5.7 kg on semaglutide 1 mg/week. The gap widens at the higher tirzepatide doses. Both produce real and clinically meaningful weight reduction; tirzepatide produces more.",
      },
      {
        q: "Which has the stronger cardiovascular outcomes evidence?",
        a: "Ozempic. SUSTAIN-6 (Marso 2016) is the positive MACE trial in high-CV-risk T2D adults at 0.5–1.0 mg/week. Tirzepatide's equivalent — SURPASS-CVOT — does not read out until 2026. For patients with established cardiovascular disease where the cardiac indication is the prescribing driver, Ozempic carries the published evidence base today.",
      },
      {
        q: "Are these drugs interchangeable?",
        a: "No. Mechanism differs: tirzepatide is a dual GIP/GLP-1 receptor agonist, semaglutide is a GLP-1-only receptor agonist. Dose ladders are not equivalent — there is no one-to-one conversion between the molecules. Switching between them is a prescribing decision, not a dose substitution. The pharmacokinetic half-lives are also slightly different (semaglutide approximately 7 days, tirzepatide approximately 5 days).",
      },
      {
        q: "What about side-effect tolerability?",
        a: "Trial-reported GI side-effect rates are broadly similar between the two molecules during titration, with discontinuation around 6–9% in the pivotal trials and meaningfully higher in real-world cohorts. Some prescribing reports suggest the GIP component of tirzepatide modestly reduces nausea at matched titration in some patient subgroups; the published data is not consistent enough to make a strong general claim.",
      },
      {
        q: "Why does Pepvise rank these drugs and the research peptides on the same scale?",
        a: "The methodology v1.2 dimensions (evidence, mechanism, human, vendor, safety) are designed to surface the gap between Phase 3 trial dossiers and rodent literature. Mounjaro and Ozempic anchor the upper bound of the database; the research peptides cluster materially below. The score gap between BPC-157 (#1 of the research peptides at 6.8) and Mounjaro (9.3) is the gap between FDA-approved Phase 3 evidence and a small preclinical dossier with one human pilot — that gap is what the methodology surfaces.",
      },
    ],
    sources: [
      { label: "Frias et al. 2021, SURPASS-2 (vs semaglutide), New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/34370970/" },
      { label: "Marso et al. 2016, SUSTAIN-6 cardiovascular outcomes, New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/27633186/" },
      ...
      { label: "EMA Mounjaro EPAR", url: "https://www.ema.europa.eu/en/medicines/human/EPAR/mounjaro" },
      { label: "Pepvise methodology v1.2", url: "/methodology/v1-2" },
    ],
  },
  {
    slug: "ozempic-vs-wegovy",
    title: "Ozempic vs. Wegovy, the Pepvise Comparison",
    h1: "Ozempic vs. Wegovy: same molecule, different label",
    description:
      "Methodology v1.2 comparison of Ozempic and Wegovy. Same active molecule (semaglutide), different FDA indications, different dose ceilings, different prescribing contexts. STEP-1 vs SUSTAIN-6, dose ladders, and the indication-driven selection.",
    hub: "evidence-reviews",
    postType: "comparison",
    publishedAt: "2026-04-28",
    updatedAt: "2026-04-28",
    ...
    faq: [
      {
        ...
        a: "The molecule is identical: semaglutide, an analogue of human GLP-1. The brand names denote different FDA-approved indications and different dose ceilings. Wegovy is the chronic-weight-management label at up to 2.4 mg/week; Ozempic is the type-2 diabetes label at up to 2.0 mg/week. Same molecule, different products.",
      },
      {
        q: "Why is Wegovy used for weight loss but Ozempic isn't supposed to be?",
        a: "FDA approval is per-indication, not per-molecule. Wegovy carries the chronic-weight-management indication on the strength of STEP-1 and the broader STEP trial program. Ozempic carries the type-2 diabetes indication on the strength of the SUSTAIN program. Off-label prescribing of Ozempic for weight management at the 2.0 mg/week dose remains common, but the clinical evidence base for that practice is the diabetes trials, not the weight-management trials.",
      },
      {
        q: "Which one has the bigger weight loss?",
        a: "Wegovy at the 2.4 mg dose. STEP-1 reported 14.9% mean weight loss at 68 weeks. Ozempic at the 1.0 mg dose in SUSTAIN-2 reported approximately 6 kg mean weight loss over 56 weeks; the higher 2.0 mg arm produced more but does not match the STEP-1 magnitude. The dose-ceiling difference is the practical reason Wegovy is the labelled weight-management product.",
      },
      {
        q: "Is one safer than the other?",
        a: "The molecule's safety profile is the molecule's safety profile — they share the boxed warning for thyroid C-cell tumours observed in rodents and the labelled risks for pancreatitis, gallbladder events, ileus, and acute kidney injury during severe GI dehydration. Side-effect rates differ slightly between the trial cohorts but the clinical safety signal is the same molecule.",
      },
      {
        q: "Can I switch from Ozempic to Wegovy?",
        a: "Switching between them is a prescribing decision and depends on the indication, the current dose, insurance coverage, and tolerability. The dose ladders overlap but are not identical. Patients should discuss any switch with their prescriber. Pepvise does not provide dosing prescriptions and does not recommend a specific telehealth provider.",
      },
    ],
    sources: [
      { label: "Wilding et al. 2021, STEP-1, New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/33567185/" },
      { label: "Marso et al. 2016, SUSTAIN-6, New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/27633186/" },
      { label: "Davies et al. 2017, SUSTAIN-2, Lancet", url: "https://pubmed.ncbi.nlm.nih.gov/29032024/" },
      { label: "Lincoff et al. 2023, SELECT cardiovascular outcomes, New England Journal of Medicine", url: "https://pubmed.ncbi.nlm.nih.gov/37952131/" },
      { label: "Rubino et al. 2021, STEP-4 maintenance, JAMA", url: "https://pubmed.ncbi.nlm.nih.gov/33755728/" },
      { label: "FDA Drugs@FDA, Wegovy labeling", url: "https://www.accessdata.fda.gov/scripts/cder/daf/" },
      { label: "FDA Drugs@FDA, Ozempic labeling", url: "https://www.accessdata.fda.gov/scripts/cder/daf/" },
      { label: "EMA Wegovy EPAR", url: "https://www.ema.europa.eu/en/medicines/human/EPAR/wegovy" },
      { label: "Pepvise methodology v1.2", url: "/methodology/v1-2" },
