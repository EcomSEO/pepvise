...
export const posts: Post[] = [
  ...
  // Retatrutide review removed per 2026-04-29 topic-boundary lock
  // (GLP-1/GIP/glucagon triple agonist — moves to peptips).
  {
  ...
  // GLP-1 comparison posts (wegovy-vs-zepbound, mounjaro-vs-ozempic,
  // ozempic-vs-wegovy) removed per 2026-04-29 topic-boundary lock —
  // pepvise covers research peptides only. Comparisons live on peptips.
];
